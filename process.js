// get data from storage, set default and display
...
// check processing, change class and save to localStorage
...
// processing tab all, pending, completed, expired
